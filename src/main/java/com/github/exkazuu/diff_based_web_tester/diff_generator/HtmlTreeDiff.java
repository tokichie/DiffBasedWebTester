...
public class HtmlTreeDiff extends HtmlDiffGenerator {
	...
	public HtmlTreeDiff() {
		try {
			...
			if (!libDir.exists()) {
				execCommand(workingDir, "git", "clone",
						"https://github.com/exKAZUu/htmltreediff.git");
			}
	...
	public String generateDiffContent(String input1, String input2,
		...
		String output = null;
		try {
			Files.write(input1.replace(
					"<?xml version=\"1.1\" encoding=\"UTF-16\"?>", ""), file1,
					Charsets.UTF_16);
			Files.write(input2.replace(
					"<?xml version=\"1.1\" encoding=\"UTF-16\"?>", ""), file2,
					Charsets.UTF_16);
			String[] ret = execCommand(workingDir, "python", "-m",
					"htmltreediff.cli", "input1.html", "input2.html");
	...
	public static String readAllText(InputStream stream, Charset charset)
		...
		String separator = System.lineSeparator();
		try (InputStreamReader streamReader = new InputStreamReader(stream,
				charset); BufferedReader br = new BufferedReader(streamReader);) {
			String line;
			while ((line = br.readLine()) != null) {
				buffer.append(line + separator);
			}
	...
	public static String[] execCommand(File dir, String... cmds)
