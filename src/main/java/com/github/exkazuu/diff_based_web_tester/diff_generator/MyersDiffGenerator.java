...
/**
 * Generate diff with java-diff-utils library which implements Myer's diff
 * algorithm.
 * 
...
public class MyersDiffGenerator extends HtmlDiffGenerator {
	...
	public String generateDiffContent(String input1, String input2,
		...
		List<String> originalContent = Arrays.asList(input1
				.split(lineSeparator));
		List<String> revisedContent = Arrays
				.asList(input2.split(lineSeparator));
